...
#### 4.1.1 张量 ([具体笔记](./data/深度学习/tensor.ipynb))<p id="tensor中的笔记绝大多数均为天池的原文件，只是根据个人理解进行了些许更改"> 
...
#### 4.1.2 反向传播([具体笔记](./data/深度学习/backward.ipynb))

#### 4.1.3 神经网络([具体笔记](./data/深度学习/neural_network.ipynb))<p id="neural_network中的笔记绝大多数均为天池的原文件，只是根据个人理解进行了些许更改"> 
##### softmax回归
